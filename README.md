...
<p align="center">
  <img src="ThunderFighterUnity/docs/media/cover.png" alt="ThunderFighter Cover" width="100%" />
</p>
...
### 机型展示
<p align="center">
  <img src="ThunderFighterUnity/docs/media/ships.png" alt="Playable Ships" width="100%" />
</p>

### Boss 展示
<p align="center">
  <img src="ThunderFighterUnity/docs/media/bosses.png" alt="Chapter Bosses" width="100%" />
</p>

### 技能特效
<p align="center">
  <img src="ThunderFighterUnity/docs/media/skill-nova.png" alt="Nova Skill" width="48%" />
  <img src="ThunderFighterUnity/docs/media/skill-overdrive.png" alt="Overdrive Skill" width="48%" />
</p>
...
- `ThunderFighterUnity/docs/media/cover.png`：仓库首页封面图
- `ThunderFighterUnity/docs/media/ships.png`：三台玩家机型展示
- `ThunderFighterUnity/docs/media/bosses.png`：三章节 Boss 展示
- `ThunderFighterUnity/docs/media/skill-*.png`：技能特效预览
